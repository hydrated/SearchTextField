...
open class SearchTextField: UITextField {
    ...
    fileprivate var direction: ScrollDirection = .down
...
//        }
    ...
    fileprivate func appendEmptyItem() {
        let attributedString = NSMutableAttributedString(string: "Tap here to leave blank", attributes: [
            .font: UIFont.museoSans500(withSize: 13),
            .foregroundColor: UIColor(red: 187.0 / 255.0, green: 193.0 / 255.0, blue: 211.0 / 255.0, alpha: 1.0)
            ])
        attributedString.addAttribute(.foregroundColor, value: UIColor(red: 0.0, green: 210.0 / 255.0, blue: 160.0 / 255.0, alpha: 1.0), range: NSRange(location: 0, length: 8))
        let emptyItem = SearchTextFieldItem(title: "-")
        emptyItem.attributedTitle = attributedString
        filteredResults.append(emptyItem)
    }
...
public struct SearchTextFieldTheme {
    ...
    public static func lightTheme() -> SearchTextFieldTheme {
        return SearchTextFieldTheme(cellHeight: 44, bgColor: UIColor.white, borderColor: UIColor (hexString: "8690ad", withAlpha: 0.25), separatorColor: UIColor.clear, font: UIFont.museoSans500(withSize: 17), fontColor: UIColor(hexString: "8690ad"))
    }
